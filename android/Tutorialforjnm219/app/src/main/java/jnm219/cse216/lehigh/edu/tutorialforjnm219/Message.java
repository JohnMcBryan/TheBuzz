...
public class Message {
    ...
    Message(int messageId, String subject,String message, String createTime, int votes, String username, String img_url_string,int pollExist){
        ...
        mFileId = img_url_string;
        mPollExist=pollExist;
    }
    Message(int messageId, String subject,String message, String createTime, int votes, String username, String img_url_string){
