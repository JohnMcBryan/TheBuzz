...
SINGLETONS=(ElementList EditEntryForm NewEntryForm NewPollForm Navbar LoginWindow CreateAccountForm NavbarLoggedIn ProfilePage EditBio ViewComments NewCommentForm NewPassForm ViewPoll)
